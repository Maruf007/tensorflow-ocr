...
- [Tesseract 5.0.0 (Set Environment Variable)](https://github.com/UB-Mannheim/tesseract/wiki)
- [ImageMagick 7.0.10](https://imagemagick.org/script/download.php#windows)
- [Ghostscript 9.52](https://ghostscript.com/releases/gsdnld.html)
- [Miniconda](https://docs.conda.io/en/latest/miniconda.html)
- [Poppler(Set Environment Variable)](https://blog.alivate.com.au/poppler-windows/)
